...
// New serialization introduced with 1.1.99
static const int DBI_OLD_SER_VERSION = 1019900;
static const int DBI_SER_VERSION_NO_ZC = 1019902;   // removes mapZerocoinSupply, nMoneySupply
...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action)
    {
        ...
        if (nSerVersion >= DBI_SER_VERSION_NO_ZC) {
            // Serialization with CLIENT_VERSION = 1019902+
            READWRITE(nFlags);
            ...
            // Serialization with CLIENT_VERSION = 1019901
            ...
            // Serialization with CLIENT_VERSION = 1019900-
            int64_t nMint = 0;
            uint256 hashNext{};
            int64_t nMoneySupply = 0;
            READWRITE(nMint);
