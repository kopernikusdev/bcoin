...
#ifndef BALLCOIN_ZBALLTRACKER_H
#define BALLCOIN_ZBALLTRACKER_H
...
public:
    CzBALLTracker(CWallet* parent);
    ~CzBALLTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBALLWallet* zBALLWallet = NULL);
