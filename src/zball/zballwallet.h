...
#ifndef BALLCOIN_ZBALLWALLET_H
#define BALLCOIN_ZBALLWALLET_H
...
public:
    ...
    void GenerateDeterministicZBALL(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBALL(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
