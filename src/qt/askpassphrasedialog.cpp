...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            BALLCOINGUI* window = static_cast<BALLCOINGUI*>(parentWidget());
...
{
    BALLCOINGUI* gui = static_cast<BALLCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<BALLCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BALLCOIN will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BALLs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
