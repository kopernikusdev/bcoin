...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // BALL Total
    QString totalBall = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    ui->labelPendingBall->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureBall->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
