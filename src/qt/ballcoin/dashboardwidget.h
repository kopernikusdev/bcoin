...
#include "qt/ballcoin/furabstractlistitemdelegate.h"
#include "qt/ballcoin/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/ballcoin/txviewholder.h"
...
#include "config/ballcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalBall = 0;
    qint64 totalZball = 0;
    QList<qreal> valuesBall;
    QList<qreal> valueszBall;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(BALLCOINGUI* _window);
    ~DashboardWidget();
