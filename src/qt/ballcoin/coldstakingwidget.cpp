...
#include "qt/ballcoin/forms/ui_coldstakingwidget.h"
#include "qt/ballcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/ballcoin/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(BALLCOINGUI* parent) :
    PWidget(parent),
