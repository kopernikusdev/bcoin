...
#ifndef BALLCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define BALLCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //BALLCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
