...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, BALLCOINGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, BALLCOINGUI* gui, double posX = 3);
