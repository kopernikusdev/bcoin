...
#include "qt/ballcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ballcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BALLCOINGUI* _window, QWidget *parent) :
