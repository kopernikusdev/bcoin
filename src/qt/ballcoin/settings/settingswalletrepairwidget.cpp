...
#include "qt/ballcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ballcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BALLCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BALLCOINGUI::handleRestart()
