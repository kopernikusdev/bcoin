...
#include "qt/ballcoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(BALLCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &BALLCOINGUI::openFAQ);
