...
#include "qt/ballcoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/ballcoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(BALLCOINGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableBALL,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableBALL,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableBALL,
    ...
    connect(ui->pushButton_UnspendableBALL, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableBALL);});
    ...
    if (parent)
        connect(parent, &BALLCOINGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
