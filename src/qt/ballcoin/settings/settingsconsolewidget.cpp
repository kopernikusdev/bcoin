...
#include "qt/ballcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ballcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BALLCOINGUI* _window, QWidget *parent) :
