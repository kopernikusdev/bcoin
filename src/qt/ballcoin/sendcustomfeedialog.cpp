...
#include "qt/ballcoin/sendcustomfeedialog.h"
#include "qt/ballcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(BALLCOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &BALLCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
