...
#include "qt/ballcoin/sendmultirow.h"
#include "qt/ballcoin/coldstakingmodel.h"
#include "qt/ballcoin/contactsdropdown.h"
#include "qt/ballcoin/addressholder.h"
...
public:
    explicit ColdStakingWidget(BALLCOINGUI* parent);
    ~ColdStakingWidget();
