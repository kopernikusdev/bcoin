...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case BALL:
        return QString("ballcoin");
    case mBALL:
        return QString("mballcoin");
    case uBALL:
        return QString::fromUtf8("uballcoin");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZball)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZBALL)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZBALL);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZBALL)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZBALL));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
