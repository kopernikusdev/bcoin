...
/** BALLCOIN unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    //! Short name
    static QString name(int unit, bool isZball = false);
    //! Longer description
    ...
    static QString floorWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZBALL = false);
    static QString floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZBALL = false);
